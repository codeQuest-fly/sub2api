...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	signatureRepository := repository.NewSignatureRepository(client, db)
	signaturePoolService := service.NewSignaturePoolService(signatureRepository)
	signatureService := service.NewSignatureService(signatureRepository)
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, userRepository, userSubscriptionRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, signaturePoolService, signatureService)
